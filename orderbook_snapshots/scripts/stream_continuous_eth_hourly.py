#!/usr/bin/env python3
"""
Production Orderbook Streaming Service - ETH Hourly

Continuously captures orderbook snapshots from Polymarket ETH hourly markets.
...
Usage:
    ...
    # Or as a service:
    launchctl load ~/Library/LaunchAgents/com.polymarket.orderbook-streamer-eth-hourly.plist
"""
...
class ConfigLoader:
    ...
    def __init__(self, config_path: str = "config/streamer_config_eth_hourly.yaml"):
...
class DataWriter:
    ...
    def flush(self, market: Dict[str, Any]):
        ...
        try:
            ...
            month = dt.strftime("%m")
            day = dt.strftime("%d")
            filename = f"orderbook_eth_hourly_{dt.strftime('%Y%m%d_%H%M')}.parquet"
