#!/usr/bin/env python3
"""
Production Orderbook Streaming Service - ETH 15min

Continuously captures orderbook snapshots from Polymarket ETH 15-minute markets.
...
Usage:
    ...
    # Or as a service:
    launchctl load ~/Library/LaunchAgents/com.polymarket.orderbook-streamer-eth-15min.plist
"""
...
class ConfigLoader:
    ...
    def __init__(self, config_path: str = "config/streamer_config_eth_15min.yaml"):
...
class DataWriter:
    ...
    def flush(self, market: Dict[str, Any]):
        ...
        try:
            ...
            month = dt.strftime("%m")
            day = dt.strftime("%d")
            filename = f"orderbook_eth_15min_{dt.strftime('%Y%m%d_%H%M')}.parquet"
