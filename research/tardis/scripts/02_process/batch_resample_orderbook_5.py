#!/usr/bin/env python3
"""
Batch resample Binance orderbook snapshot (top 5 levels) files to 1-second intervals.
...
Usage:
    # Process all files
    uv run python batch_resample_orderbook_5.py \
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Batch resample Binance orderbook snapshot (top 5 levels) data to 1-second intervals",
...
Examples:
  ...
  uv run python batch_resample_orderbook_5.py \
    ...
    checkpoint_file = os.path.join(args.checkpoint_dir, "batch_orderbook_5_resample_progress.json")
    completed_files = set()
